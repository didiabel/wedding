  ...
  return (
    <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
      <div className="sm:text-center lg:text-left">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6l">
          <span className="text-4l block ">{mainHero.title}</span>
        </h1>
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6l">
        ...
        <p
          ...
          dangerouslySetInnerHTML={{
            __html: mainHero.description.replace(/\n/g, '<br />'),
          }}
        />
